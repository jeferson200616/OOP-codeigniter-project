...
<a  class="button is-link is-light" href="<?= site_url("/profile/edit/") ?>"><?= lang('Profile.edit') ?></a>

<a class="button is-link is-light" href="<?= site_url("/profile/editpassword/") ?>"><?= lang('Profile.change_password') ?></a>

<a class="button is-link is-light" href="<?= site_url("/profileimage/edit/") ?>"><?= lang('Profile.change_profile_image') ?></a>
